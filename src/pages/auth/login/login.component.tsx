			...
			<div className="card-content">
				<form>
					<div className="form-group">
						...
						<input ref={userNameRef} className="form-control" type="text" name="username" id="username"
						       placeholder="Username"/>
					</div>
					<div className="form-group">
						<label htmlFor="password">Password</label>
						<input ref={passwordRef} className="form-control" type="password" name="password" id="password"
